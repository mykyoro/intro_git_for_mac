<template>
  <v-container>
    ...
    <v-row>
      <v-col v-for="(title, i) in newTitles" :key="i" cols="12">
        <v-card :color="title.color" @click="$router.push('/quiz/' + title.id)">
          <div class="d-flex">
...
export default class Home extends Vue {
  ...
  // getNewTitles() {
  //   const data = this.axios.get("/titles/new");
  //   return data;
  // }
  ...
  // mounted() {
  //   // 新着タイトル一覧取得
  //   this.newTitles = this.getNewTitles();
  //   // カテゴリ一覧取得
